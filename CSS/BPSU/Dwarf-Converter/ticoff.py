...
class Coff(object):
    ...
    def get_section_by_name(self, name):
        if name in self.sectionsDict:
            return self.sectionsDict[name]
    ...
    def from_stream(self, f):
        ...
        self.header = self.header._replace(target_id = self.device_magic[self.header.target_id])
        ...
        for i in range(self.header.section_count):
            ...
            self.sectionsDict[section.name] = section
